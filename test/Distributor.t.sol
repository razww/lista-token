...
contract DistributorTest is Test {
    ...
    Distributor public distributor = Distributor(0x836611FE256A8ACDBBB23306A0bc7C1654035fDE);
    ...
    function setUp() public {
        ...
        address impl = address(new Distributor());
    ...
    function test_depositReward() public {
        Distributor.TokenAmount[] memory tokens = new Distributor.TokenAmount[](2);
        ...
        Distributor.TokenAmount[] memory rewardData = distributor.getTotalRewardByWeek(week);
    ...
    function test_claim() public {
        Distributor.TokenAmount[] memory tokensAmount = new Distributor.TokenAmount[](2);
        ...
        Distributor.TokenAmount[] memory tokenAmounts = distributor.getClaimable(user1);
        ...
        Distributor.TokenAmount[] memory tokenAmounts2 = distributor.getClaimable(user2);
...
//        distributor.claim(tokens);
//
//        assertEq(token1.balanceOf(user1), 100 ether, "user1 has not claimed token1");
//        assertEq(token2.balanceOf(user1), 1000 ether, "user1 has not claimed token2");
    }
}
